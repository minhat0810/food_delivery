...
public class BestFoodAdapter extends RecyclerView.Adapter<BestFoodAdapter.viewholder> {
    ...
    @NonNull
    @Override
    public BestFoodAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
...
//        View inflate = LayoutInflater.from()
    ...
    @Override
    public void onBindViewHolder(@NonNull BestFoodAdapter.viewholder viewholder, int i) {
