...
public class HomeChefAdapter extends RecyclerView.Adapter<HomeChefAdapter.viewholder> {
    ArrayList<Foods> items;
    Context context;
    public HomeChefAdapter(ArrayList<Foods> items){
        this.items = items;
    }
    @NonNull
    @Override
    public HomeChefAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomeChefAdapter.viewholder viewholder, int i) {
